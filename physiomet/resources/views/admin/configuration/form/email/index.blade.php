...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.configuration.form.email.store', 'files'=> true]) !!}
            <div class="panel-body">
                ...
                <?php
                $idRoute = $id;
                $routeBack = route('admin.configuration.form.edit', ['id' => $id]);
                ?>

                @include('admin.configuration.form.inc.menu')

                @include('admin.configuration.form.email._form')
                        ...
                        @foreach($dados as $row)
                            <tr>
                                ...
                                <td data-title="Ação" class="actions text-center">
                                    <a href="#modalDestroy" data-route="{{ route('admin.configuration.form.email.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
