...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::model($dados, ['route'=>['admin.faq.update', $dados->id], 'files' => true]) !!}
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <a href="{{ route('admin.faq.index') }}" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-undo"></i> Voltar</a>
                        </div>
                    </div>
