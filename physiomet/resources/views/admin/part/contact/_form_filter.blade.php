{!! Form::open(['route' => 'admin.part.contact.index', 'method' => 'get']) !!}
<div class="row">
    <div class="col-md-12">
        <div class="col-md-6">
    ...
    <div class="col-md-12 text-right">
        <a href="{{ route('admin.part.contact.index') }}" title="Limpar" class="btn btn-danger mb-md"><i class="fa fa-trash"></i> Limpar</a>
