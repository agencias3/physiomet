{!! Form::open(['route' => 'admin.technical-assistance.technical-assistance.index', 'method' => 'get']) !!}
<div class="row">
    <div class="col-md-12">
        <div class="col-md-6">
    ...
    <div class="col-md-12 text-right">
        <a href="{{ route('admin.technical-assistance.technical-assistance.index') }}" title="Limpar" class="btn btn-danger mb-md"><i class="fa fa-trash"></i> Limpar</a>
