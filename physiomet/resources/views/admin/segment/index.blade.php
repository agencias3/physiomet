                        ...
                        @foreach($dados as $row)
                            <tr>
                                ...
                                <td data-title="Ação" class="actions text-center">
                                    <a href="{{ route('admin.segment.client.index', ['id' => $row->id]) }}" class="btn btn-default white-hover" title="Clientes"><i class="fa fa-users"></i></a>
                                    <a href="{{ route('admin.segment.gallery.index', ['id' => $row->id]) }}" class="btn btn-default white-hover" title="Galeria"><i class="fa fa-image"></i></a>
                                    <a href="{{ route('admin.segment.edit', ['id' => $row->id]) }}" class="btn btn-default white-hover" title="Editar"><i class="fa el-icon-file-edit"></i></a>
