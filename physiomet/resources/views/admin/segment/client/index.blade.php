...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.segment.client.store', 'files'=> true]) !!}
                <div class="panel-body">
                    ...
                    @include('admin.segment.client._form')
                </div>
                    ...
                    @foreach($dados as $row)
                        <tr>
                            ...
                            <td data-title="Ação" class="actions text-center">
                                <a href="#modalDestroy" data-route="{{ route('admin.segment.client.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
