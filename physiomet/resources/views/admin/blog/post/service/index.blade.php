...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.blog.post.services.store', 'files'=> true]) !!}
                <div class="panel-body">
                    ...
                    @include('admin.blog.post.service._form')
                    ...
                    @foreach($dados as $row)
                        <tr>
                            ...
                            <td data-title="Ação" class="actions text-center">
                                <a href="#modalDestroy" data-route="{{ route('admin.blog.post.services.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
