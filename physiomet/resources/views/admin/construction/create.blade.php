...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.construction.store', 'files'=> true]) !!}
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <a href="{{ route('admin.construction.index') }}" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-undo"></i> Voltar</a>
                    </div>
                </div>
