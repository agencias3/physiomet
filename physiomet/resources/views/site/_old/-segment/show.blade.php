...
@section('content')
    ...
    <section class="w-100">
        <div class="center-2">
            <div class="w-100 m-top-40 d_flex bg-white-1 box-middle-2 relative w-1024-100 p-top-1024-30 p-bottom-1024-30 m-top-1024-30 column-800">
                    ...
                    <div class="w-100 buttons d_flex wrap justify-800-center">
                        <a class="d_flex justify-center main-bg smooth" target="_blank" href="{{ asset('uploads/segment/'.$segment->file) }}" title="Baixar PDF com Informações">
                            <figure class="self-center">
                                <img src="{{ asset('assets/site/images/pdf.png') }}" title="Baixar PDF com Informações" alt="Baixar PDF com Informações" />
                            </figure>
                ...
                <section class="d_flex flex-1 flex-order-1 justify-center bg-white overflow-h b-radius-10 w-800-100 m-top-800-30" data-scroll-reveal="enter right move 50px">
                    ...
                    @foreach($images as $row)
                            <li class="f-left">
                                <a class="def-100 h-100 d_flex justify-center" href="{{ asset('uploads/segment/'.$row->image) }}" title="{{ $row->label }}">
                                    <figure class="self-center">
    ...
    <section class="w-100 p-top-50 p-bottom-50 p-top-1024-30 p-bottom-1024-30">
        <div class="center">
            ...
            <ul class="w-90 m-left-5 m-top-50 slider-slick-3 w-1024-100 m-top-1024-30" data-scroll-reveal="enter bottom move 50px">
    ...
    <section class="w-100 p-top-50 p-top-1024-0">
        <div class="center-2">
            <article class="w-100 w-1024-100 m-top-1024-30">
                <h3 class="w-100 t-align-c color-grey f-size-40 f-w-800 f-size-1024-26 f-size-600-20" data-scroll-reveal="enter bottom move 50px">
