        ...
        <div class="center">
            ...
            @else
                ...
                @foreach($segments as $row)
                    ...
                    ?>
            <div class="w-90 m-left-5 m-top-40 d_flex bg-white-1 {{ $class }} relative w-1024-100 p-top-1024-30 p-bottom-1024-30 m-top-1024-30 column-800" data-scroll-reveal="enter bottom move 50px">
