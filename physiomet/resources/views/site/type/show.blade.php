                ...
                <article class="w-100 m-top-50 d_flex wrap page-service m-top-1024-30">
                    ...
                    <aside class="w-1024-100 m-top-1024-30">
                        <ul class="w-100 b-radius-20 overflow-h gallery slider-slick-1">
                            ...
                            <li class="f-left">
                                <figure>
                                    <a class="max-w-100 b-radius-20 overflow-h html5lightbox" data-group="images" href="{{ asset('uploads/type/'.$row->image) }}">
                                        <img class="w-100 relative z-index-1" src="{{ asset('uploads/type/'.$row->image) }}" title="{{ $row->label }}" alt="{{ $row->label }}" />
                                    </a>
                                </figure>
                            </li>
                            @endforeach
