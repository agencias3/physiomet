...
@section('content')
    <section class="w-100 p-top-50 p-top-1024-30">
        <div class="center">
            ...
            <div class="w-90 m-left-5 m-top-40 w-1024-100 m-top-1024-30 t-align-1024-c">
				...
				<ul class="w-80 m-left-10 m-top-40 list-group-gallery slider-slick-1 m-top-1024-30" data-scroll-reveal="enter bottom move 50px">
					...
					<li class="f-left">
						<figure class="w-100 h-100 d_flex justify-center t-align-c">
							<a class="self-center max-w-100 html5lightbox" data-group="images" href="{{ asset('uploads/post/'.$image->image) }}" title="{{ $image->label }}">
