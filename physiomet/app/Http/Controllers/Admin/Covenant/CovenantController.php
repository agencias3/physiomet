...
namespace AgenciaS3\Http\Controllers\Admin\Covenant;
...
class CovenantController extends Controller
{
    ...
    public function __construct(CovenantRepository $repository,
                                CovenantValidator $validator,
                                UtilObjeto $utilObjeto)
    {
        $this->repository = $repository;
        $this->validator = $validator;
        $this->utilObjeto = $utilObjeto;
        $this->path = 'uploads/covenant/';
    }
    ...
    public function index()
    {
        ...
        return view('admin.covenant.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Convênios";
        $config['activeMenu'] = "covenant";
        $config['activeMenuN2'] = "covenant";
    ...
    public function create()
    {
        ...
        return view('admin.covenant.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.covenant.edit', compact('dados', 'config'));
    }
