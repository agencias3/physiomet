...
class EnterpriseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.enterprise.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Empreendimentos";
    ...
    public function create()
    {
        ...
        return view('admin.enterprise.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.enterprise.edit', compact('dados', 'config'));
    }
