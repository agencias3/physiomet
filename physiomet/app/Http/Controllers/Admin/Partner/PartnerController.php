...
class PartnerController extends Controller
{
    ...
    {
        $config['title'] = "Contato Parceiros";
    ...
    public function show($id)
    {
        ...
        return view('admin.partner.show', compact('dados', 'config'));
    }
    ...
    public function export(Request $request)
    {
        ...
        header("Content-Disposition: attachment; filename=\"Parceiros_" . date('Ymds') . ".csv\"");
        ...
        foreach ($listar as $dados) {
            ...
            $item = '"';
            $item .= utf8_decode($dados->social_reason) . '";"';
            $item .= utf8_decode($dados->fantasy_name) . '";"';
            $item .= utf8_decode($dados->cnpj) . '";"';
            $item .= utf8_decode($dados->state_registration) . '";"';
            $item .= utf8_decode($dados->address) . '";"';
            $item .= utf8_decode($dados->neighborhood) . '";"';
