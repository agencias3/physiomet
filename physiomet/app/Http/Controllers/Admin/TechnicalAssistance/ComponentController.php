...
use AgenciaS3\Validators\ComponentValidator;
...
class ComponentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.technical-assistance.component.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Assistência Técnica > Componentes";
        $config['activeMenu'] = "technical-assistance";
        $config['activeMenuN2'] = "component";
    ...
    public function create()
    {
        ...
        return view('admin.technical-assistance.component.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.technical-assistance.component.edit', compact('dados', 'config'));
    }
