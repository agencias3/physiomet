...
use AgenciaS3\Validators\TypeProductValidator;
...
class TypeProductController extends Controller
{
    ...
    public function __construct(TypeProductRepository $repository,
                                TypeProductValidator $validator)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.technical-assistance.type-product.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Assistência Técnica > Tipo Produto";
        $config['activeMenu'] = "technical-assistance";
        $config['activeMenuN2'] = "type-product";
    ...
    public function create()
    {
        ...
        return view('admin.technical-assistance.type-product.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.technical-assistance.type-product.edit', compact('dados', 'config'));
    }
