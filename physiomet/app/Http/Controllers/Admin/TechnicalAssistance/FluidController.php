...
use AgenciaS3\Validators\FluidValidator;
...
class FluidController extends Controller
{
    ...
    public function __construct(FluidRepository $repository,
                                FluidValidator $validator)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.technical-assistance.fluid.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Assistência Técnica > Fluidos";
        $config['activeMenu'] = "technical-assistance";
        $config['activeMenuN2'] = "fluid";
    ...
    public function create()
    {
        ...
        return view('admin.technical-assistance.fluid.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.technical-assistance.fluid.edit', compact('dados', 'config'));
    }
