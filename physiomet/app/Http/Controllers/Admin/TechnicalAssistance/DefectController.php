...
use AgenciaS3\Validators\DefectValidator;
...
class DefectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.technical-assistance.defect.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Assistência Técnica > Defeitos";
        $config['activeMenu'] = "technical-assistance";
        $config['activeMenuN2'] = "defect";
    ...
    public function create()
    {
        ...
        return view('admin.technical-assistance.defect.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.technical-assistance.defect.edit', compact('dados', 'config'));
    }
