...
class ProductTextController extends Controller
{
    ...
    public function __construct(ProductTextRepository $repository,
                                ProductTextValidator $validator,
                                UtilObjeto $utilObjeto)
    {
        $this->repository = $repository;
        $this->validator = $validator;
        $this->utilObjeto = $utilObjeto;
        $this->path = 'uploads/product/text/';
    }
    ...
    public function index($product_id)
    {
        ...
        return view('admin.product.text.index', compact('dados', 'config', 'product_id'));
    }

    public function header()
    {
        $config['title'] = "Produtos > Textos";
    ...
    public function create($product_id)
    {
        ...
        return view('admin.product.text.create', compact('config', 'product_id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.product.text.edit', compact('dados', 'config', 'product_id'));
    }
