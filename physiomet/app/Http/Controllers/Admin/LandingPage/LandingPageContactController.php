...
class LandingPageContactController extends Controller
{
    ...
    public function index(AdminRequest $request, $landing_page_id)
    {
        ...
        return view('admin.landing-page.contact.index', compact('dados', 'config'));
    }
    ...
    public function all(AdminRequest $request)
    {
        ...
        return view('admin.landing-page.contact.all', compact('dados', 'config'));
    }
    ...
    public function show(AdminRequest $request, $id)
    {
        ...
        return view('admin.landing-page.contact.show', compact('dados', 'config'));
    }
