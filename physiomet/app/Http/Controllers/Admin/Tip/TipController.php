...
class TipController extends Controller
{
    ...
    public function __construct(TipRepository $repository,
                                ...
                                TipItemController $tipItemController,
                                UtilObjeto $utilObjeto)
    {
        $this->repository = $repository;
        $this->validator = $validator;
        $this->tipItemController = $tipItemController;
        $this->utilObjeto = $utilObjeto;
        $this->path = 'uploads/tip/';
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.tip.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Você Sabia";
        $config['activeMenu'] = "tip";
        $config['activeMenuN2'] = "tip";
    ...
    public function create()
    {
        ...
        return view('admin.tip.create', compact('config'));
    }
    ...
    public function store(AdminRequest $request)
    {
        try {
            ...
            return redirect()->route('admin.tip.item.index', ['id' => $dados->id])->with('success', $response['success']);
    ...
    public function edit($id)
    {
        ...
        return view('admin.tip.edit', compact('dados', 'config'));
    }
    ...
    {
        $this->tipItemController->destroyTip($id);
