...
use AgenciaS3\Entities\PartContact;
use Illuminate\Mail\Mailable;

class PartClientMail extends Mailable
{
    public $contact;

    public $form;

    public function __construct(PartContact $contact, $form)
    {
    ...
    public function build()
    {
        ...
        $email = $this->subject($subject)
            ...
            ->view('vendor.emails.site.part.client');
